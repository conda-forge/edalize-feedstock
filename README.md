...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/edalize-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6645&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/edalize-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `edalize` can be installed with:

```
conda install edalize
```

It is possible to list all of the versions of `edalize` available on your platform with:
